    ...
    if (!napaka1 && !napaka2){
      ...
      vrniStranke(function(napaka1, stranke) {
        vrniRacune(function(napaka2, racuni) {
          ...
          odgovor.render('prijava', {sporocilo: "Prislo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.", seznamStrank: stranke, seznamRacunov: racuni});
        })
